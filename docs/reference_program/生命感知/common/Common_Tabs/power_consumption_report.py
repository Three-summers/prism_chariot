...
class PowerReport():
    def __init__(self):
        ...
        self.powerVsTimePlotBoxGroup = QGroupBox(tr("Power Consumption Over Time"))
        self.powerVsTimePlot = pg.PlotWidget()
        self.powerVsTimePlot.setLabel("left", tr("Measured Power Consumption (mW)"))
        self.powerVsTimePlot.setLabel("bottom", tr("Time (seconds) "))
        ...
        self.powerStatsPane = QGroupBox(tr("Power Consumption Stats"))
    ...
    def initPowerStatsTable(self):
        ...
        self.avgPowerLabelCell = QTableWidgetItem(tr('Average Power :'))
        self.maxPowerLabelCell = QTableWidgetItem(tr('Max Power :'))
        self.minPowerLabelCell = QTableWidgetItem(tr('Min Power :'))

        self.powerStatsTable.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
        self.powerStatsTable.verticalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
