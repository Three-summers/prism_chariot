...
class FalseAlarm():
    def __init__(self):
        ...
        self.detStatsPane = QGroupBox(tr("False Alarm Stats"))
        ...
        self.pointCloudPlotPane = QGroupBox(tr("False Alarm Locations"))
    ...
    def initFalseAlarmTable(self):
        ...
        self.firstPassFAStats = QTableWidgetItem(tr('Mode 1'))
        self.secondPassFAStats = QTableWidgetItem(tr('Mode 2'))
        self.thirdPassFAStats = QTableWidgetItem(tr('Mode 3'))
        self.cameraOnFAStats = QTableWidgetItem(tr('Camera On'))

        self.percentTimeTableItem = QTableWidgetItem(tr('% of time in mode'))
        self.numTimesTableItem = QTableWidgetItem(tr('# of times mode entered'))

        self.falseAlarmTable.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
        self.falseAlarmTable.verticalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
