...
class LevelSensing(Plot1D):
    ...
    def setupGUI(self, gridLayout, demoTabs, device):
        ...
        self.ObjectNo.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.ObjectNo1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.ObjectNo2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.ObjectNo3.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        comment1 = tr("Distance in meters") 
        label_text1 = f"{comment1}"
        self.PeakListOutput = QLabel(label_text1)
        self.PeakListOutput.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakListOutput1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakListOutput2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakListOutput3.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakMagnitudeOutput.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakMagnitudeOutput1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakMagnitudeOutput2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PeakMagnitudeOutput3.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.PowerOutput.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        noteLabel = QLabel(tr("Note : Peaks are ordered based on their relative power. Peak with the highest relative power is designated as Peak 1"))
        font = QFont("Arial", 8)
        ...
        self.peakScatterPlot.getPlotItem().setLabel("bottom", tr("Frame Number"))
        self.peakScatterPlot.getPlotItem().setLabel("left", tr("Distance in Meters"))
        self.peakScatterPlot.getPlotItem().setLabel("top", tr("Peak Movement over time"))
        ...
        self.levelsensingTab.setLayout(vboxLevelSense)
        demoTabs.addTab(self.levelsensingTab, tr("Level Sensing"))
